<?php
	...
	$mail->Subject = "[People Portal] New Maconomy user request - " . $emp["firstname"] . " " . $emp["lastname"];
	...
	$mail->Body = "
						<body>
							...
							<p>This is an automatic email sent by People Portal for Maconomy provisioning.</p>
						</body>
					";

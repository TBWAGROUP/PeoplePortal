...
Includes:
index.php?p=emp
jtable/employeeListQueries.php?action=listTemporaryStaff

Form actions:

-->

<div id="PeopleTableContainerTemporaryStaff" style="width: 100%; overflow-x: scroll"></div>
	...
	<script type="text/javascript">
		...
		{
		    //Prepare jTable
			$('#PeopleTableContainerTemporaryStaff').jtable({
				...
				actions: {
					listAction: 'jtable/employeesListQueries.php?action=listTemporaryStaff'
				},
					fields: {
						idE: {
							key: true,
			...
			$('#PeopleTableContainerTemporaryStaff').jtable('load');

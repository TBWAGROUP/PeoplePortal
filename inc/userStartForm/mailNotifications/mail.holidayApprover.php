<?php
	...
	if (mysql_num_rows($queryEmail) > 0) {
		...
		$mail->Subject = "[People Portal] You are the holiday approver of " . $emp["firstname"] . " " . $emp["lastname"];
	...
	if ($emp["endDate"] == "") {
		...
		$mail->Body = "
						<body>
							...
							<p>A request from People Portal for a new user shows you are his holiday approver.
		...
		$mail->AltBody = "
							Hello, a request from People Portal for a new user shows you are his holiday approver.
								";

<?php
	$queryEmail = mysql_query("
										...
										WHERE groups.groupName = \"$pp_carfleet\" 
										") or die (mysql_error());
	...
	$mail->Subject = "[People Portal] New user notification for car fleet provisioning - " . $emp["firstname"] . " " . $emp["lastname"];
	...
	$mail->Body = "
						<body>
							...
							<p>This is an automatic email sent by People Portal for car fleet provisioning.</p>
						</body>
					";

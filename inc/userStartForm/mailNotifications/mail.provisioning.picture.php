<?php
	...
	$mail->Subject = "[People Portal] New user notification - picture for " . $emp["firstname"] . " " . $emp["lastname"];
	...
	$mail->Body = "
						<body>
							...
							<p>This is an automatic email sended by People Portal for picture provisioning.</p>
						</body>
					";

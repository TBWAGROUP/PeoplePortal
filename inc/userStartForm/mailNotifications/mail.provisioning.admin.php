<?php
	$queryEmail = mysql_query("
										...
										WHERE groups.groupName = \"$pp_admin\" 
										") or die (mysql_error());
	...
	$mail->Subject = "[People Portal] New Active Directory user request - " . $emp["firstname"] . " " . $emp["lastname"];
	...
	$mail->Body = "
						<body>
							...
							<p>This is an automatic email sent by People Portal for provisioning services.</p>
						</body>
					";

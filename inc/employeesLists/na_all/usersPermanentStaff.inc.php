...
Includes:
index.php?p=emp
jtable/employeeListQueries.php?action=listPermanentStaff

Form actions:

-->

<div id="PeopleTableContainerPermanentStaff" style="width: 100%; overflow-x: scroll"></div>
	...
	<script type="text/javascript">
		...
		{
		    //Prepare jTable
			$('#PeopleTableContainerPermanentStaff').jtable({
				title: 'Permanent Staff (Bosses, Employees and Contractors)',
				paging: true,
				pageSize: 500,
				sorting: true,
				defaultSorting: 'firstname ASC',
				actions: {
					listAction: 'jtable/employeesListQueries.php?action=listPermanentStaff'
				},
					fields: {
						idE: {
							key: true,
			...
			$('#PeopleTableContainerPermanentStaff').jtable('load');

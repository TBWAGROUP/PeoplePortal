<?php
	...
	$mail->Subject = "[People Portal] HR approval request - " . $firstname . " " . $lastname;
	...
	$mail->Body = "
					<body>
						...
						<p>A request from People Portal for a new user needs your HR approval.</p>
							<p><strong>Start date : " . $startDate . "</strong></p>
						...
						<p>This is an automatic email sent by People Portal for HR.</p>
					</body>
					";

	// if the mail viewer don't support html
	$mail->AltBody = "
						Hello, a request from People Portal for a new user needs your HR approval.
							";

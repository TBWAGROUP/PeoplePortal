...
Includes:
index.php?p=emp
jtable/usersStatutQueries.php?action=listStandalone

Form actions:

-->

<div id="PeopleTableContainerStandalone" style="width: 100%; overflow-x: scroll"></div>
	...
	<script type="text/javascript">
		...
		{
		    //Prepare jTable
			$('#PeopleTableContainerStandalone').jtable({
				title: 'Standalone Users, employee.ppAccountStatut = 3',
				paging: true,
				pageSize: 500,
				sorting: true,
				selecting : true,
				...
				actions: {
					listAction: 'jtable/usersStatutQueries.php?action=listStandalone'
				},
					fields: {
						idE: {
							key: true,
			...
			$('#PeopleTableContainerStandalone').jtable('load');

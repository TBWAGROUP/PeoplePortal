<?php
	$queryEmail = mysql_query("
										...
										WHERE groups.groupName = \"$pp_facebook\" 
										") or die (mysql_error());
	...
	$mail->Subject = "[People Portal] New Facebook user request - " . $emp["firstname"] . " " . $emp["lastname"];
	...
	$mail->Body = "
						<body>
							...
							<p>This is an automatic email sended by People Portal for provisioning services.</p>
						</body>
					";

<!--
This script defines the gCal functions
...
<?php
function addGcal($date, $userName, $type)
{
	if ($type == 0) { $text = "User Start : "; $contract = " start "; } 
		else if ($type == 1) { $text = "User End : "; $contract = " end ";}
	...
	$event->title = $service->newTitle($text.$userName);
	$event->content =
		$service->newContent("User".$contract."contract date");

...
<div id="PeopleTableContainerPPHR" style="width: 100%; overflow-x: scroll"></div>
<script type="text/javascript">

	$(document).ready(function ()
	{
		//Prepare jTable
		$('#PeopleTableContainerPPHR').jtable({
			title: 'List of People (and their HR details)',
			paging: true,
			pageSize: 500,
			sorting: true,
		...
		$('#PeopleTableContainerPPHR').jtable('load');

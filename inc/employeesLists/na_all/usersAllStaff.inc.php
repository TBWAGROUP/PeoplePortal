...
Includes:
index.php?p=emp
jtable/employeeListQueries.php?action=listAllStaff

Form actions:

-->

<div id="PeopleTableContainerAllStaff" style="width: 100%; overflow-x: scroll"></div>
	...
	<script type="text/javascript">
		...
		{
		    //Prepare jTable
			$('#PeopleTableContainerAllStaff').jtable({
				title: 'All Staff',
				paging: true,
				pageSize: 500,
				sorting: true,
			...
			$('#PeopleTableContainerAllStaff').jtable('load');

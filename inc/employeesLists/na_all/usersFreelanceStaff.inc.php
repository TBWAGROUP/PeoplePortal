...
Includes:
index.php?p=emp
jtable/employeeListQueries.php?action=listFreelanceStaff

Form actions:

-->

<div id="PeopleTableContainerFreelanceStaff" style="width: 100%; overflow-x: scroll"></div>
	...
	<script type="text/javascript">
		...
		{
		    //Prepare jTable
			$('#PeopleTableContainerFreelanceStaff').jtable({
				title: 'Freelancers',
				paging: true,
				pageSize: 500,
				sorting: true,
				...
				actions: {
					listAction: 'jtable/employeesListQueries.php?action=listFreelanceStaff'
				},
					fields: {
						idE: {
							key: true,
			...
			$('#PeopleTableContainerFreelanceStaff').jtable('load');

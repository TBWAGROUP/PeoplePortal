<?php
	...
	$mail->Subject = "[People Portal] New business card request - " . $emp["firstname"] . " " . $emp["lastname"];
	...
	$mail->Body = "
						<body>
							...
							<p>This is an automatic email sent by People Portal for business card provisioning.</p>
						</body>
					";

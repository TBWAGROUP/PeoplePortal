<?php
	$queryEmail = mysql_query("
										...
										WHERE groups.groupName = \"$pp_building\" 
										") or die (mysql_error());
	...
	$mail->Subject = "[People Portal] New user notification for building provisioning - " . $emp["firstname"] . " " . $emp["lastname"];
	...
	$mail->Body = "
						<body>
							...
							<p>This is an automatic email sent by People Portal for building provisioning.</p>
						</body>
					";
